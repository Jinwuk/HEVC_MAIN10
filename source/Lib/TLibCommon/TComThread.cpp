...
void	TComThread::SetProcessGroupOption( unsigned short nGroup, unsigned __int64 nAffinityMask )
{

}

bool	TComThread::GetAffinity( unsigned short * pusGroup, unsigned __int64* pullAffinityMask )
{
	return true;
}
